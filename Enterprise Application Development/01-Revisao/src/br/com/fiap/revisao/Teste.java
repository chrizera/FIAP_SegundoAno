...
public class Teste {
	...
	public static void main(String[] args) {
		...
		Produto produto = new Produto(1, "Título 1", 666);
		Tablet tablet = new Tablet(2, "Eletrônicos", 4545, "Samsung", "Apple", "Linux", true);
		...
		Livro livro3 = new Livro(5,"Livro 4", 55, "Valéria", "Poker", dataLancamento3);
}
